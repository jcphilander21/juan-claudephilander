/*
	A Helper javascript function for Webgep Livedesign Editor;
	CSS Animation trigger and Custom CSS Engine.
	Visit the plugin website to the details: Webgep.com/yellow-pencil

	By Webgep / All Rights Reserved.
*/
(function($) {
