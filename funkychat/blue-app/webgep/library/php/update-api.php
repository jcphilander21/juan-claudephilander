<?php
/*
    Webgep Livedesign Auto Update API
*/

// General.
define("YP_TIMEOUT", 9999999400); // 1 DAY = 86400
...
function yp_getting_ver_from_changelog(){
    ...
    // Changelog URL
    $url = "http://www.Webgep.com/yellow-pencil/inc/changelog.txt";
...
function yp_get_plugin_patch(){
    ...
    // Checks download uri
    $download_uri = 'http://webgep.co.za/livedesign/auto-update/download.php?purchase_code='.YP_PURCHASE_CODE;
...
function yp_remote_request( $url ) {
    ...
    $args = array(
        ...
        'timeout'    => 300000,
        'user-agent' => 'Webgep Livedesign Updater',
    );
    ...
    if(defined('WTFV')){
        ...
        if($isUpdate != 'true' && current_user_can("update_plugins") == true && YP_PURCHASE_CODE == '' && strstr($base,"yellow-pencil") == false){
            ...
            <div class="updated yp-update-info-bar">
                <p><?php _e("Hola! Would you like to receive automatic updates? Please <a style='box-shadow:none !important;-webkit-box-shadow:none !important;-moz-box-shadow:none !important;' href='".admin_url('admin.php?page=yellow-pencil-license')."'>activate your copy</a> of Webgep Livedesign.","yp"); ?></p>
            </div>
        <?php
        }
        ...
        if($isUpdate == 'true' && $lastCheckVer == YP_PLUGIN_VERSION && $available > YP_PLUGIN_VERSION && current_user_can("update_plugins") == true && YP_PURCHASE_CODE != ''){
            ...
            ?>
            <div class="updated yp-update-info-bar">
                <p><strong><?php _e("A new update available for Webgep Livedesign,","yp"); ?> <a style="box-shadow:none !important;-webkit-box-shadow:none !important;-moz-box-shadow:none !important;" href="#" class="yp_update_link"><?php _e("Update now!","yp"); ?></a></strong></p>
            </div>
            <?php
...
function yp_update_now(){
    ...
    if($isUpdate == 'true' && $lastCheckVer == YP_PLUGIN_VERSION && $available > YP_PLUGIN_VERSION && current_user_can("update_plugins") == true && YP_PURCHASE_CODE != ''){
        ...
        $re = yp_get_plugin(array(
            array('name' => 'yellow_pencil_update_pack', 'path' => $path, 'install' => 'webgep-yellow-pencil/yellow-pencil.php'),
        ));
...
function yp_upgrade_now(){
    ...
    if(defined('WTFV') == false){
        ...
        // Delete lite plugin
        delete_plugins(array('/webgep-visual-theme-customizer/yellow-pencil.php'));

    }

    die("Webgep Livedesign Activated");
    ...
    jQuery(document).ready(function($) {
        ...
        if(jQuery(".yp-upgrade-pro-action").length > 0){
            ...
            jQuery.post(ajaxurl,data, function(response) {
                ...
                // Resualt: Webgep Livedesign Activated or error.
                ...
                // update desc
                jQuery(".yp-activation-section .description").html("Webgep Livedesign Pro Successfully installed. <a href='<?php echo admin_url('admin.php?page=yp-welcome-screen'); ?>'>Let's Start</a>");
