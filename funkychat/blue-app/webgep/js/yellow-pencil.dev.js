;(function($) {
    ...
    // All Webgep Livedesign Functions.
    window.yellow_pencil_main = function() {
            ...
            function get_cleaned_classes(el,oldArray){
                ...
                if(isDefined(classes)){
                    ...
                    // Cleaning all Webgep Livedesign classes.
            ...
            // Webgep Livedesign Toggle Advanced Boxes. Used For Parallax, Transform.
            ...
            // The title
            $("title").html("Webgep Livedesign: " + iframe.find("title").html());
            ...
            /* ---------------------------------------------------- */
            /* Resize.                                              */
            /* Dynamic resize Webgep Livedesign panel                   */
            /* ---------------------------------------------------- */
            function gui_update() {
            ...
            iframe.on("mouseover", iframe, function(evt){
               ...
               if ($(".yp-selector-mode.active").length > 0 && mainBody.hasClass("yp-metric-disable")){
                    ...
                    // If not any Webgep Livedesign element.
            ...
            function set_default_value(id) {
                ...
                setTimeout(function() {
                    ...
                    // Webgep Livedesign using css engine for parallax Property.
            ...
            /* ---------------------------------------------------- */
            /*
                 the most important function in Webgep Livedesign scripts
            ...
            function get_best_class($element){
                ...
                // Clean Webgep Livedesign Classes
            ...
            */
            ...
            function process(close, id, type) {
                ...
                setTimeout(function() {
                    ...
                    if (editor.getValue().toString().indexOf("@media") != -1) {
                        ...
                        // Search medias and convert to Webgep Livedesign Data
            ...
            // Clean classes by Webgep Livedesign control classes.
        ...
        }; // Webgep Livedesign main function.
