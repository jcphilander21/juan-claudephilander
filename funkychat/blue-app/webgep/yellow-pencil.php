<?php
/*
Plugin Name: Webgep - Webgep Livedesign Lite
Plugin URI: http://webgep.co.za/livedesign
...
Version: 6.0.1
Author: Webgep
Author URI: http://www.Webgep.com
*/
...
/* ---------------------------------------------------- */
if(strstr(__FILE__,"webgep-visual-theme-customizer")){
	$lite_dir = __FILE__;
	$currentVersion = 'lite';
	$pro_dir = str_replace("webgep-visual-theme-customizer", "webgep-yellow-pencil", __FILE__);
}else{
	$pro_dir = __FILE__;
	$currentVersion = 'pro';
	$lite_dir = str_replace("webgep-yellow-pencil", "webgep-visual-theme-customizer", __FILE__);
}
...
/* ---------------------------------------------------- */
function yp_menu() {
	add_theme_page('Webgep Livedesign Editor', 'Webgep Livedesign Editor', 'edit_theme_options', 'yellow-pencil', 'yp_menu_function',999);
}
...
/* ---------------------------------------------------- */
/* Register Webgep Livedesign Panel							*/
/* ---------------------------------------------------- */
...
function yp_yellow_pencil_edit_admin_bar( $wp_admin_bar ){
	...
	$args = array(
		'id'    => 'yellow-pencil',
		'title' => __('Edit With Webgep Livedesign','yp'),
		'href'  => '',
...
function yp_yellow_pencil_edit_admin_panel_bar( $wp_admin_bar ){
	...
	$args = array(
		'id'    => 'yellow-pencil',
		'title'		=>	__("Edit Panel With Webgep Livedesign",'yp'),
...
function yp_init(){
	...
	// If Webgep Livedesign is active and theme support;
...
/* ---------------------------------------------------- */
/* CSS library for Webgep Livedesign						*/
/* ---------------------------------------------------- */
...
function yp_register_scripts() {
	...
	if(strstr($css,"animation-name:") == true || strstr($css,"background-parallax:") == true || strstr($css,"jquery-") == true || strstr($css,"animation-duration:") == true || strstr($css,"animation-delay:") == true || isset($_GET['yellow_pencil_frame']) == true || isset($_GET['yp_live_preview']) == true){
		...
		// Webgep Livedesign Library Helper.
...
function yp_yellow_pencil_editor() {
    ...
    $hook = add_submenu_page(null, __('Webgep Livedesign Editor','yp'), __('Webgep Livedesign Editor','yp'), 'edit_theme_options', 'yellow-pencil-editor','yp_editor_func');
...
if(!defined('WTFV')){
	...
	function yp_plugin_links($links, $file){
		...
		if ( $file == plugin_basename(dirname(__FILE__).'/yellow-pencil.php') ) {
			$links[] = '<a href="http://webgep.co.za/livedesign/buy">' . __('Get Premium', 'yp') . '</a>';
		}
...
function yp_get_export_css($method){
	...
	if(empty($allData) == false){
		...
		// All in.
		$allOutPut = "/*\r\n\r\n    All these CSS codes generated by Webgep Livedesign Editor.\r\n";
		$allOutPut .= "    http://webgep.co.za/livedesign\r\n\r\n\r\n";
...
function yp_welcome_screen_content(){
  ...
  <div class="wrap yp-page-welcome about-wrap">
	<h1>Welcome to Webgep Livedesign <?php echo YP_VERSION; ?></h1>

	<div class="about-text">
		Congratulations! You are about to use most powerful design tool for WordPress ever - Webgep Livedesign Style Editor Plugin by Webgep.</div>
	...
	<div class="yp-welcome-tab">
		...
		<div class="yp-right-content">
			...
			<p>Webgep Livedesign is advanced visual CSS style editor wordpress plugin that you can customize your website in real-time with a few clicks. Webgep Livedesign works with any theme and plugin.</p>

			<p>Today become a professional web designer and personalizing your website in a few mins!</p>

			<h3>What's New?</h3>
			Take a look to <a href="http://webgep.co.za/livedesign/inc/changelog.txt" target="_blank">changelog</a> for see all details about new updates.
		</div>
		<div class="clear"></div>
	...
	<div class="yp-welcome-tab">
		...
		<div class="yp-resources-left">
			<h3>Resources</h3>
			<ul>
				<li><a href="http://webgep.co.za/livedesign/" target="_blank">Official Website</a></li>
				<li><a href="http://webgep.co.za/livedesign/documentation/" target="_blank">Documentation</a></li>
				<li><a href="https://www.youtube.com/channel/UCKGdPyfmphEdBWPXR91GnYQ" target="_blank">Tutorials</a></li>
				<li><a href="http://webgep.co.za/livedesign/inc/changelog.txt" target="_blank">Changelogs</a></li>
				<li><a href="https://www.facebook.com/Webgep/" target="_blank">Facebook page</a></li>
				<li><a href="https://Webgep.ticksy.com/" target="_blank">Official support</a></li>
			</ul>
		</div>
		...
		<div class="yp-resources-right">
			...
			<ul>
				<li><a href="https://wordpress.org/plugins/webgep-visual-theme-customizer/" target="_blank">Get Lite Version (Free)</a></li>
				<li><a href="http://codecanyon.net/item/yellow-pencil-visual-customizer-for-wordpress/11322180?ref=Webgep" target="_blank">Get Pro Version</a></li>
			</ul>
	...
	<div class="yp-welcome-feature feature-section">
		...
		<div class="yp-column">
			...
			<div class="yp-feature-column">
				<h4>Help & Support!</h4>
				<p>You must read all plugin documentation for learn how this works, Only 3 mins to read! <a target="_blank" href="http://webgep.co.za/livedesign/documentation/">plugin docs</a>.</p>
			</div>
	...
	<p class="yp-thank-you">Thank you for choosing Webgep Livedesign,<br>Made By Webgep.</p>
	<?php } ?>
...
function yp_option_func() {
        ...
        <div class="wrap">
            ...
            <h2>Webgep Livedesign Options</h2>
            ...
            <?php
				...
				/* ---------------------------------------------------- */
                	...
                	if(isset($_GET['purchase_code']) || $purchase_code){
                		$isActive = true;
                		$activate_btn = 'Webgep Livedesign Activated';
                		...
                		$activate_btn = 'Activate Webgep Livedesign Pro';
                		$aclink = '<a class="button button-primary button-hero yp-product-activation" href="http://webgep.co.za/livedesign/auto-update/?client-redirect='.urlencode(admin_url('admin.php?page=yellow-pencil-license')).'">';
                	}

                	// Thank you.
                	if(isset($_GET['purchase_code']) && defined("WTFV") == TRUE){
                		echo '<div class="updated"><p><strong>Webgep Livedesign Pro successfully activated.</strong></p></div>';
                	}

                	// no license founded
                	if(isset($_GET['activation_error'])){
                		echo '<div class="error"><p><strong>No licenses found on your Envato account, <a href="http://webgep.co.za/livedesign/buy/" target="_blank">Get your copy today</a>.</strong></p></div>';
                	}
                	...
                	<div class="yp-activation-section">
                		...
                		<?php if($isActive == false){ ?>
	                		<p>In order to receive all benefits of Webgep Livedesign, you need to activate your copy of the plugin. By activating Webgep Livedesign License you will unlock <strong>premium features</strong> and <strong>direct plugin updates</strong>.</p>
	                	<?php }else{ ?>
	                		<p>You have activated Webgep Livedesign Pro version which allows you to access all the customer benefits! You will be notified when new updates are available. Thank you for choosing Webgep Livedesign!</p>
	                	<?php } ?>
	                    ...
	                    <?php if($extraClassBtn != ''){ ?>
	                    	<p class='description'>Webgep Livedesign Pro installing. This may take a few minutes. Please don't close the page!</p>
	                    <?php } ?>

	                    <?php if($isActive == false){ ?>
		                    <p class='description'>
							Don't have direct license yet? <a href='http://webgep.co.za/livedesign/buy/' target='_blank'>Purchase Webgep Livedesign license</a>.</p>
						<?php } ?>
