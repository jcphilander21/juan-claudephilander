...
<body class="<?php echo $classesReturn; ?>">
	...
	<div id="responsive-size-text"><a href="http://webgep.co.za/livedesign/documentation/#responsive-tool" target="_blank" class="support-icon" data-toggle='tooltip' data-placement='right' title='Click here to take a look at Responsive Tool docs.'>?</a> Customizing for <span class="device-size"></span>px and <span class="media-control" data-code="max-width">below</span> screen sizes. <span class="device-name"></span></div>

	<?php yp_yellow_penci_bar(); ?>
	
	<div class="top-area-btn-group">
		<a target="blank" class="yellow-pencil-logo" href="http://webgep.co.za/livedesign"></a>
	...
	<div class="yp-info-modal">
		...
		<div class="yp-action-area">
			...
			<a class="yp-buy-link" target="_blank" href="http://webgep.co.za/livedesign/buy"><?php _e("Get Premium","yp"); ?></a>
				...
				setTimeout(function(){
					...
					function yp_eval_scripts() {
				        ...
				        iframe.find("link[rel='stylesheet'][href]").each(function(){
				            ...
				            // check and add
				            if(href.indexOf("webgep-yellow-pencil") == -1 &&
