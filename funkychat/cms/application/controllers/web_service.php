...
//        }
    ...
    public function send_mail($subject,$email,$body) {
        ...
        $mail->Username   = "gretchenclaasen@gmail.com";  // user email address
        $mail->Password   = "0813047916";            // password in GMail
        $mail->SetFrom('gretchenclaasen@gmail.com', 'Juan Philander');  //Who is sending the email
        $mail->AddReplyTo("info@funkychat.co.za","JC");  //email address that receives the response
